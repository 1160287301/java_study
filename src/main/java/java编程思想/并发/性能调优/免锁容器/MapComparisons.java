package java编程思想.并发.性能调优.免锁容器;//: concurrency/MapComparisons.java
// {Args: 1 10 10} (Fast verification check during build)
// Rough comparison of thread-safe Map performance.

import java编程思想.net.mindview.util.CountingGenerator;
import java编程思想.net.mindview.util.MapData;
